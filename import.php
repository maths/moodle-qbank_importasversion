...
require_once($CFG->dirroot . '/question/bank/importasversion/classes/form/import_form.php');
require_once($CFG->dirroot . '/question/format.php');
require_once($CFG->dirroot . '/question/renderer.php');

use qbank_importasversion\form\question_import_form;

require_login();
core_question\local\bank\helper::require_plugin_enabled('qbank_importasversion');
list($thispageurl, $contexts, $cmid, $cm, $module, $pagevars) =
        question_edit_setup('import', '/question/bank/importasversion/import.php');

// Get display strings.
$txt = new stdClass();
$txt->importerror = get_string('importerror', 'qbank_importasversion');
$txt->importasversion = get_string('importasversion', 'qbank_importasversion');
...
// Page header.
$PAGE->set_title($txt->importasversion);
...
echo $OUTPUT->heading_with_help($txt->importasversion, 'importasversion', 'qbank_importasversion');
